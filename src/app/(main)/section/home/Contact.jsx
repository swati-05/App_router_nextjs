...
export default function Contact() {
  return (
    <div className="bg-gray-50">
      <section className="relative z-[5] overflow-hidden  px-6 lg:px-20 py-16 mx-auto">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <MotionContainer variants={varFade().inUp}>
                  <span className="mb-4 block text-base font-semibold text-green-600">
                    Contact Us
                  </span>
                </MotionContainer>
                <MotionContainer variants={varFade().inUp}>
                  <h2 className="mb-6 text-[32px] font-bold uppercase text-green-600 sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                ...
                <MotionContainer variants={varFade().inUp}>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="mb-1 text-xl font-bold text-green-600">
                        Our Location
                      </h4>
                      <p className="text-sm text-gray-500">
                        01 Fal-mandi daily market main road Ranchi 834001. India
                      </p>
                    </div>
                  </div>
                </MotionContainer>
                <MotionContainer variants={varFade().inUp}>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm text-gray-500">(+91)9709227856</p>
                    </div>
                  </div>
                </MotionContainer>
                <MotionContainer variants={varFade().inUp}>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-sm text-gray-500">
                        fruitzyinternationals@gmail.com
                      </p>
                    </div>
                  </div>
                </MotionContainer>
                ...
                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  <form>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full rounded border border-green-600 bg-green-600 p-3 text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
